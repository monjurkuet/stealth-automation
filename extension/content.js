    ...
    try {
        switch (command.action) {
            case 'navigate':
                ...
                // Prepare the result message BEFORE navigation
                result = { id: command.id, status: 'success', message: 'Navigation initiated' };

                // Attempt to send the result message, and then navigate.
                ...
                chrome.runtime.sendMessage(result, (response) => {
                    ...
                    // Navigate, even if sending the message failed, as the page context is lost anyway
